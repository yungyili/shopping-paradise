...
export const UPDATEING_USER_ORDERS = 'canceling_user_orders';
export const UPDATE_USER_ORDERS_OK = 'cancel_user_orders_ok';
export const UPDATE_USER_ORDERS_FAIL = 'cancel_user_orders_fail';
